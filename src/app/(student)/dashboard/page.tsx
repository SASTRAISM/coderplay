            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/aptitude">
                <motion.div
                  ...
                  className="group bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100/10 rounded-2xl p-6 hover:border-indigo-300 transition-colors cursor-pointer h-full flex flex-col"
                >
